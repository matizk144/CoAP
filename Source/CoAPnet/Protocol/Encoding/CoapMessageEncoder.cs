...
internal sealed class CoapMessageEncoder
{
    ...
    private static void EncodeOptions(IEnumerable<CoapMessageOption>? options, CoapMessageWriter writer)
    {
        if (options == null)
        {
            return;
    ...
    static byte[] EncodeUintOptionValue(uint value)
    {
        ...
        if (value <= 65535U)
        {
            return [(byte)(value >> 8), (byte)(value >> 0)];
        }

        if (value <= 16777215U)
        {
            return [(byte)(value >> 16), (byte)(value >> 8), (byte)(value >> 0)];
        }

        return [(byte)(value >> 24), (byte)(value >> 16), (byte)(value >> 8), (byte)(value >> 0)];
    }

    private static void EncodeOptionValue(int value, out int nibble)
    {
        if (value <= 12)
        {
            nibble = value;
    ...
    private static void ThrowIfInvalid(CoapMessage message)
    {
    ...
    private static void ThrowIfInvalid(CoapMessageCode code)
    {
        if (code == null)
        {
